...
class FeedRepositoryTest extends Specification {
    ...
    def "조회가 된다."(){
        ...
        def post1 = new Feed(title: "Title1", description: "Description1", lastBuildTime: LocalDateTime.of(2024, 11, 16, 10, 0))
        def post2 = new Feed(title: "Title2", description: "Description2", lastBuildTime: LocalDateTime.of(2024, 11, 17, 12, 0))
        def post3 = new Feed(title: "Title3", description: "Description3", lastBuildTime: LocalDateTime.of(2024, 11, 15, 9, 0))
